...
namespace VIrecord
{
    public partial class TaskThumbnailPanel : UserControl
    {
        ...
        {
            lblTitle.ForeColor = VIrecordResources.Theme.TextColor;
            lblTitle.TextShadowColor = VIrecordResources.Theme.DarkBackgroundColor;
            pThumbnail.PanelColor = VIrecordResources.Theme.DarkBackgroundColor;
            ttMain.BackColor = VIrecordResources.Theme.BackgroundColor;
            ttMain.ForeColor = VIrecordResources.Theme.TextColor;
            lblCombineHorizontal.BorderColor = VIrecordResources.Theme.BorderColor;
            lblCombineVertical.BorderColor = VIrecordResources.Theme.BorderColor;
        }
