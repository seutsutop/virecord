    ...
    public class ImageData : IDisposable
    {
        ...
        public bool Write(string filePath)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    message += "\r\n\r\n" + Resources.YourAntiVirusSoftwareOrTheControlledFolderAccessFeatureInWindowsCouldBeBlockingVIrecord;
                }

                MessageBox.Show(message, "VIrecord - " + Resources.Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
