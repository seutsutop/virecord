    ...
    public static class TaskHelpers
    {
        ...
        public static void OpenDebugLog()
        {
            ...
            if (!form.HasUploadRequested)
            {
                ...
                {
                    if (MessageBox.Show(form, Resources.MainForm_UploadDebugLogWarning, "VIrecord", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                    {
                ...
                if (!string.IsNullOrEmpty(input))
                {
                    ...
                    if (taskSettings.GeneralSettings.ShowToastNotificationAfterTaskCompleted)
                    {
                        ShowNotificationTip(string.Format(Resources.TaskHelpers_OpenQuickScreenColorPicker_Copied_to_clipboard___0_, text),
                            "VIrecord - " + Resources.ScreenColorPicker);
                    }
                }
            }
        }
        ...
        public static void AnnotateImageFromFile(string filePath, TaskSettings taskSettings = null)
        {
            ...
            {
                MessageBox.Show("File does not exist:" + Environment.NewLine + filePath, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public static void RunVIrecordAsAdmin(string arguments = null)
        {
            try
            {
        ...
        public static void PinToScreen(Image image, Point? location, TaskSettings taskSettings = null)
        {
            if (image != null)
            {
                ...
                options.BackgroundColor = VIrecordResources.Theme.LightBackgroundColor;
        ...
        public static void PinToScreenFromClipboard(TaskSettings taskSettings = null)
        {
            ...
            {
                MessageBox.Show(Resources.ClipboardDoesNotContainAnImage, "VIrecord - " + Resources.PinToScreen, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public static bool CheckFFmpeg(TaskSettings taskSettings)
        {
            if (!Environment.Is64BitOperatingSystem && !taskSettings.CaptureSettings.FFmpegOptions.OverrideCLIPath)
            {
                MessageBox.Show(Resources.FFmpegOnlySupports64BitOperatingSystems,
                    "VIrecord - " + Resources.FFmpegIsMissing, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public static bool CheckExifTool()
        {
            ...
            if (!File.Exists(exifToolPath))
            {
                ...
                MessageBox.Show("ExifTool does not exist at the following path:" + "\r\n" + exifToolPath,
                    "VIrecord - " + "ExifTool is missing", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public static Image FindMenuIcon<T>(T value) where T : Enum
        {
            if (value is AfterCaptureTasks afterCaptureTask)
            {
                switch (afterCaptureTask)
                {
                    ...
                    case AfterCaptureTasks.ScanQRCode: return VIrecordResources.IsDarkTheme ? Resources.barcode_2d_white : Resources.barcode_2d;
                    case AfterCaptureTasks.DoOCR: return VIrecordResources.IsDarkTheme ? Resources.edit_drop_cap_white : Resources.edit_drop_cap;
            ...
            else if (value is AfterUploadTasks afterUploadTask)
            {
                switch (afterUploadTask)
                {
                    ...
                    case AfterUploadTasks.UseURLShortener: return VIrecordResources.IsDarkTheme ? Resources.edit_scale_white : Resources.edit_scale;
                    ...
                    case AfterUploadTasks.ShowQRCode: return VIrecordResources.IsDarkTheme ? Resources.barcode_2d_white : Resources.barcode_2d;
                }
            }
            else if (value is HotkeyType hotkeyType)
            {
                switch (hotkeyType)
                {
                    ...
                    case HotkeyType.ShortenURL: return VIrecordResources.IsDarkTheme ? Resources.edit_scale_white : Resources.edit_scale;
                    ...
                    case HotkeyType.OCR: return VIrecordResources.IsDarkTheme ? Resources.edit_drop_cap_white : Resources.edit_drop_cap;
                    case HotkeyType.QRCode: return VIrecordResources.IsDarkTheme ? Resources.barcode_2d_white : Resources.barcode_2d;
                    case HotkeyType.QRCodeDecodeFromScreen: return VIrecordResources.IsDarkTheme ? Resources.barcode_2d_white : Resources.barcode_2d;
                    case HotkeyType.QRCodeScanRegion: return VIrecordResources.IsDarkTheme ? Resources.barcode_2d_white : Resources.barcode_2d;
                    ...
                    case HotkeyType.ExitVIrecord: return Resources.cross;
                }
            }
                    ...
                    if (cui != null)
                    {
                        ...
                        if (cui.DestinationType == CustomUploaderDestinationType.None)
                        {
                            DialogResult result = MessageBox.Show($"Would you like to add \"{cui}\" custom uploader?",
                                "VIrecord - Custom uploader confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
                        ...
                        else
                        {
                            ...
                            DialogResult result = MessageBox.Show($"Would you like to set \"{cui}\" as the active custom uploader for {destinationsText}?",
                                "VIrecord - Custom uploader confirmation", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        ...
        public static void ImportImageEffect(string filePath)
        {
            ...
            if (!string.IsNullOrEmpty(configJson))
            {
                ...
                if (!Program.DefaultTaskSettings.AfterCaptureJob.HasFlag(AfterCaptureTasks.AddImageEffects) &&
                    ...
                    "VIrecord", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
        ...
        {
            GitHubUpdateChecker updateChecker = new GitHubUpdateChecker("VIrecord", "DevBuilds")
            {
                IsDev = true,
            ...
            {
                MessageBox.Show(Resources.VIrecordIsUpToDate, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public static void ShowNotificationTip(string text, string title = "VIrecord", int duration = -1)
        {
            if (duration < 0)
            {
        ...
        public static bool IsUploadAllowed()
        {
            ...
            {
                MessageBox.Show(Resources.YourSystemAdminDisabledTheUploadFeature, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show(Resources.ThisFeatureWillNotWorkWhenDisableUploadOptionIsEnabled, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
