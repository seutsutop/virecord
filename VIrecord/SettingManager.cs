...
namespace VIrecord
{
    internal static class SettingManager
    {
        ...
        private static void Settings_SettingsSaveFailed(Exception e)
        {
            ...
            {
                message = Resources.YourAntiVirusSoftwareOrTheControlledFolderAccessFeatureInWindowsCouldBeBlockingVIrecord;
            }
            else
            {
                message = e.Message;
            ...
            TaskHelpers.ShowNotificationTip(message, "VIrecord - " + Resources.FailedToSaveSettings, 5000);
        }
        ...
        private static void ApplicationConfigBackwardCompatibilityTasks()
        {
            ...
            {
                if (Helpers.IsDefaultSettings(Settings.Themes, VIrecordTheme.GetDefaultThemes(), (x, y) => x.Name == y.Name))
                {
                    ...
                    VIrecordTheme selectedTheme = Settings.Themes[Settings.SelectedTheme];

                    Settings.Themes = VIrecordTheme.GetDefaultThemes();
