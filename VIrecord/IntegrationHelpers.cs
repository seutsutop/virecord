...
namespace VIrecord
{
    public static class IntegrationHelpers
    {
        ...
        private static readonly string FileIconPath = $"\"{FileHelpers.GetAbsolutePath("VIrecord_File_Icon.ico")}\"";

        private static readonly string ShellExtMenuName = "VIrecord";
        ...
        private static readonly string ShellExtDesc = Resources.IntegrationHelpers_UploadWithVIrecord;
        ...
        private static readonly string ShellExtEditName = "VIrecordImageEditor";
        ...
        private static readonly string ShellExtEditDesc = Resources.IntegrationHelpers_EditWithVIrecord;
        ...
        private static readonly string ShellCustomUploaderExtensionValue = "VIrecord.sxcu";
        private static readonly string ShellCustomUploaderAssociatePath = $@"Software\Classes\{ShellCustomUploaderExtensionValue}";
        private static readonly string ShellCustomUploaderAssociateValue = "VIrecord custom uploader";
        ...
        private static readonly string ShellImageEffectExtensionValue = "VIrecord.sxie";
        private static readonly string ShellImageEffectAssociatePath = $@"Software\Classes\{ShellImageEffectExtensionValue}";
        private static readonly string ShellImageEffectAssociateValue = "VIrecord image effect";
        ...
        private static readonly string ChromeNativeMessagingHosts = @"SOFTWARE\Google\Chrome\NativeMessagingHosts\com.getVIrecord.VIrecord";
        private static readonly string FirefoxNativeMessagingHosts = @"SOFTWARE\Mozilla\NativeMessagingHosts\VIrecord";
        ...
        {
            return ShortcutHelpers.CheckShortcut(Environment.SpecialFolder.SendTo, "VIrecord", Application.ExecutablePath);
        }

        public static bool CreateSendToMenuButton(bool create)
        {
            return ShortcutHelpers.SetShortcut(create, Environment.SpecialFolder.SendTo, "VIrecord", Application.ExecutablePath);
        }
        ...
        public static void SteamShowInApp(bool showInApp)
        {
            ...
            MessageBox.Show(Resources.ApplicationSettingsForm_cbSteamShowInApp_CheckedChanged_For_settings_to_take_effect_VIrecord_needs_to_be_reopened_from_Steam_,
                "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
