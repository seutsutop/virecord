...
namespace VIrecord
{
    public partial class QuickTaskMenuEditorForm : Form
    {
        ...
        {
            if (MessageBox.Show(Resources.QuickTaskMenuEditorForm_Reset_all_quick_tasks_to_defaults_Confirmation, "VIrecord", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
