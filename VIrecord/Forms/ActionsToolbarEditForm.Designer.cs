namespace VIrecord
{
    partial class ActionsToolbarEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnAdd = new VIrecord.HelpersLib.MenuButton();
            this.cmsAction = new System.Windows.Forms.ContextMenuStrip(this.components);
            this.lvActions = new VIrecord.HelpersLib.MyListView();
            ...
            this.lvActions.ItemMoved += new VIrecord.HelpersLib.MyListView.ListViewItemMovedEventHandler(this.lvActions_ItemMoved);
            // 
            // chAction
            // 
