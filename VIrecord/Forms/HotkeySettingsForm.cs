...
namespace VIrecord
{
    public partial class HotkeySettingsForm : Form
    {
        ...
        {
            if (MessageBox.Show(Resources.HotkeySettingsForm_Reset_all_hotkeys_to_defaults_Confirmation, "VIrecord", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
