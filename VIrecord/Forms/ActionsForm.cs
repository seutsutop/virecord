...
namespace VIrecord
{
    public partial class ActionsForm : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.ActionsForm_btnOK_Click_Name_can_t_be_empty_, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            if (string.IsNullOrEmpty(txtPath.Text))
            {
                MessageBox.Show(Resources.ActionsForm_btnOK_Click_File_path_can_t_be_empty_, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
