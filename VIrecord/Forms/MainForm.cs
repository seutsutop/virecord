...
namespace VIrecord
{
    public partial class MainForm : HotkeyForm
    {
        ...
        private async void MainForm_HandleCreated(object sender, EventArgs e)
        {
            ...
            NativeMethods.UseImmersiveDarkMode(Handle, VIrecordResources.IsDarkTheme);
        ...
        private void InitializeControls()
        {
            ...
            VIrecordResources.UseWhiteIcon = Program.Settings.UseWhiteVIrecordIcon;

            Icon = VIrecordResources.Icon;
            niTray.Icon = VIrecordResources.Icon;
            Text = Program.Title;
            ...
            // TODO: Translate
#if STEAM
            tsbDonate.Text = "VIrecord website...";
        ...
        protected override void WndProc(ref Message m)
        {
            if (m.Msg == (int)WindowsMessages.QUERYENDSESSION)
            {
                ...
                if (reason.HasFlag(EndSessionReasons.ENDSESSION_CLOSEAPP))
                {
                    ...
                    // Add the silent switch to avoid VIrecord popping up in front of the user when the application restarts.
        ...
        public void UpdateTheme()
        {
            ...
            {
                Program.Settings.Themes = VIrecordTheme.GetDefaultThemes();
            ...
            VIrecordResources.Theme = Program.Settings.Themes[Program.Settings.SelectedTheme];
...
#pragma warning disable WFO5001
            if (VIrecordResources.IsDarkTheme)
            {
...
#pragma warning restore WFO5001
            ...
            BackColor = VIrecordResources.Theme.BackgroundColor;
            tsMain.Font = VIrecordResources.Theme.MenuFont;
            tsMain.Renderer = new ToolStripDarkRenderer();
            tsMain.DrawCustomBorder = false;
            VIrecordResources.ApplyCustomThemeToContextMenuStrip(cmsTray);
            VIrecordResources.ApplyCustomThemeToContextMenuStrip(cmsTaskInfo);
            ttMain.BackColor = VIrecordResources.Theme.BackgroundColor;
            ttMain.ForeColor = VIrecordResources.Theme.TextColor;
            lvUploads.BackColor = VIrecordResources.Theme.BackgroundColor;
            lvUploads.ForeColor = VIrecordResources.Theme.TextColor;
            scMain.SplitterColor = VIrecordResources.Theme.BackgroundColor;
            scMain.SplitterLineColor = VIrecordResources.Theme.BorderColor;
            VIrecordResources.ApplyCustomThemeToControl(dgvHotkeys);
            dgvHotkeys.BackgroundColor = VIrecordResources.Theme.BackgroundColor;

            tsbX.Image = VIrecordResources.IsDarkTheme ? Resources.X_white : Resources.X_black;
            tsbDiscord.Image = VIrecordResources.IsDarkTheme ? Resources.Discord_white : Resources.Discord_black;
        ...
        private void AfterApplicationSettingsJobs()
        {
            ...
            if (VIrecordResources.UseWhiteIcon != Program.Settings.UseWhiteVIrecordIcon)
            {
                VIrecordResources.UseWhiteIcon = Program.Settings.UseWhiteVIrecordIcon;
        ...
        public void ForceClose()
        {
            ...
            {
                if (MessageBox.Show(Resources.VIrecordCannotBeClosedWhileScreenRecordingIsActive, "VIrecord",
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (e.CloseReason == CloseReason.UserClosing && Program.Settings.ShowTray && !forceClose)
            {
                ...
                {
                    TaskHelpers.ShowNotificationTip(Resources.VIrecordIsMinimizedToTheSystemTray, "VIrecord", 8000);
        ...
        {
            UploadManager.UploadImage(VIrecordResources.Logo);
        }
        ...
        {
            UploadManager.UploadImage(VIrecordResources.Logo, ImageDestination.FileUploader, Program.DefaultTaskSettings.FileDestination);
        }
        ...
        private void tsmiDeleteSelectedFile_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show(Resources.MainForm_tsmiDeleteSelectedFile_Click_Do_you_really_want_to_delete_this_file_,
                "VIrecord - " + Resources.MainForm_tsmiDeleteSelectedFile_Click_File_delete_confirmation, MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                uim.DeleteFiles();
                RemoveSelectedItems();
            }
