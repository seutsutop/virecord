...
namespace VIrecord
{
    public partial class TaskSettingsForm : Form
    {
        ...
        public TaskSettingsForm(TaskSettings hotkeySetting, bool isDefault = false)
        {
            ...
            tsmiURLShorteners.Image = VIrecordResources.IsDarkTheme ? Resources.edit_scale_white : Resources.edit_scale;
        ...
        private void UpdateWindowTitle()
        {
            if (IsDefault)
            {
                Text = "VIrecord - " + Resources.TaskSettingsForm_UpdateWindowTitle_Task_settings;
            }
            else
            {
                Text = "VIrecord - " + string.Format(Resources.TaskSettingsForm_UpdateWindowTitle_Task_settings_for__0_, TaskSettings);
            }
        }
        ...
        private void UpdateNameFormatPreviews()
        {
            ...
            nameParser.ProcessName = "VIrecord";
