...
namespace VIrecord
{
    public partial class ApplicationSettingsForm : Form
    {
        ...
        private void InitializeControls()
        {
            ...
            eiTheme.ObjectType = typeof(VIrecordTheme);
        ...
        private void UpdateControls()
        {
            ...
            cbUseWhiteVIrecordIcon.Checked = Program.Settings.UseWhiteVIrecordIcon;
            ...
            cbEditWithVIrecord.Visible = false;
            ...
            cbEditWithVIrecord.Checked = IntegrationHelpers.CheckEditShellContextMenuButton();
        ...
        private void ChangeLanguage(SupportedLanguage language)
        {
            ...
            if (ready)
            {
                ...
                if (LanguageHelper.ChangeLanguage(Program.Settings.Language) &&
                    ...
                    Resources.VIrecordConfirmation, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    Program.Restart();
                }
            }
        ...
        private void CbUseWhiteVIrecordIcon_CheckedChanged(object sender, EventArgs e)
        {
            Program.Settings.UseWhiteVIrecordIcon = cbUseWhiteVIrecordIcon.Checked;
        }
        ...
        private void AddTheme(VIrecordTheme theme)
        {
            if (theme != null)
            {
        ...
        {
            AddTheme(VIrecordTheme.DarkTheme);
        }
        ...
        {
            return pgTheme.SelectedObject as VIrecordTheme;
        }

        private void EiTheme_ImportRequested(object obj)
        {
            AddTheme(obj as VIrecordTheme);
        }

        private void BtnThemeReset_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show(Resources.WouldYouLikeToResetThemes, "VIrecord - " + Resources.Confirmation, MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
        ...
        private void cbEditWithVIrecord_CheckedChanged(object sender, EventArgs e)
        {
            if (ready)
            {
                IntegrationHelpers.CreateEditShellContextMenuButton(cbEditWithVIrecord.Checked);
            }
        }
        ...
        {
            URLHelpers.OpenURL("https://chrome.google.com/webstore/detail/VIrecord/nlkoigbdolhchiicbonbihbphgamnaoc");
        }
        ...
        {
            URLHelpers.OpenURL("https://addons.mozilla.org/en-US/firefox/addon/VIrecord/");
        }
        ...
        {
            FileHelpers.BrowseFolder(Resources.ApplicationSettingsForm_btnBrowsePersonalFolderPath_Click_Choose_VIrecord_personal_folder_path,
        ...
        private void btnPersonalFolderPathApply_Click(object sender, EventArgs e)
        {
            ...
            if (!currentPersonalPath.Equals(lastPersonalPath, StringComparison.OrdinalIgnoreCase) && Program.WritePersonalPathConfig(currentPersonalPath))
            {
                ...
                if (MessageBox.Show(Resources.VIrecordNeedsToBeRestartedForThePersonalFolderChangesToApply, Resources.VIrecordConfirmation,
        ...
        private async void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (exportSettings || exportHistory)
            {
                using (SaveFileDialog sfd = new SaveFileDialog())
                {
                    ...
                    sfd.FileName = $"VIrecord-{Helpers.GetApplicationVersion()}-{sanitizedMachineName}-backup.sxb";
                    sfd.Filter = "VIrecord backup (*.sxb)|*.sxb|All files (*.*)|*.*";
        ...
        private async void btnImport_Click(object sender, EventArgs e)
        {
            ...
            {
                ofd.Filter = "VIrecord backup (*.sxb)|*.sxb|All files (*.*)|*.*";
        ...
        {
            if (MessageBox.Show(Resources.ApplicationSettingsForm_btnResetSettings_Click_WouldYouLikeToResetVIrecordSettings, "VIrecord - " + Resources.Confirmation,
