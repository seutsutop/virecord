...
namespace VIrecord
{
    internal class VIrecordUpdateManager : GitHubUpdateManager
    {
        ...
        public override GitHubUpdateChecker CreateUpdateChecker()
        {
            ...
            {
                return new GitHubUpdateChecker("VIrecord", "DevBuilds")
                {
                    IsDev = true,
            ...
            {
                return new GitHubUpdateChecker("VIrecord", "VIrecord")
                {
                    IsPortable = Program.Portable,
