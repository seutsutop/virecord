...
namespace VIrecord.ScreenCaptureLib
{
    public partial class FFmpegOptionsForm : Form
    {
        ...
        private async void btnInstallHelperDevices_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("File not exists: \"" + filePath + "\"", "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            if (MessageBox.Show(Resources.WouldYouLikeToResetOptions, "VIrecord - " + Resources.Confirmation, MessageBoxButtons.YesNo,
