    ...
    public sealed class RegionCaptureLightForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            if (!isTransparentBackground)
            {
                ...
                Text = "VIrecord - " + Resources.RectangleLight_InitializeComponent_Rectangle_capture_light;
            }
            else
            {
                Text = "VIrecord - " + Resources.RectangleTransparent_RectangleTransparent_Rectangle_capture_transparent;
            }
            ShowInTaskbar = false;
#if !DEBUG
            TopMost = true;
