...
namespace VIrecord.ScreenCaptureLib
{
    public sealed class RegionCaptureForm : Form
    {
        ...
        public RegionCaptureForm(RegionCaptureMode mode, RegionCaptureOptions options, Bitmap canvas = null)
        {
            ...
            canvasBackgroundColor = VIrecordResources.Theme.BackgroundColor;
            canvasBorderColor = VIrecordResources.Theme.BorderColor;
            textColor = VIrecordResources.Theme.TextColor;
            textShadowColor = VIrecordResources.Theme.BorderColor;
            textBackgroundColor = Color.FromArgb(200, VIrecordResources.Theme.BackgroundColor);
            textOuterBorderColor = Color.FromArgb(200, VIrecordResources.Theme.SeparatorDarkColor);
            textInnerBorderColor = Color.FromArgb(200, VIrecordResources.Theme.SeparatorLightColor);
        ...
        internal void UpdateTitle()
        {
            ...
            if (IsEditorMode)
            {
                title.AppendFormat("VIrecord - {0}", Resources.RegionCaptureForm_InitializeComponent_ImageEditor);
            ...
            {
                title.AppendFormat("VIrecord - {0}", Resources.BaseRegionForm_InitializeComponent_Region_capture);
            }
        ...
        internal void InitBackground(Bitmap canvas, bool centerCanvas = true)
        {
            ...
            if (IsEditorMode)
            {
                ...
                using (Graphics g = Graphics.FromImage(background))
                {
                    ...
                    if (VIrecordResources.Theme.CheckerSize > 0)
                    {
                        using (Bitmap checkers = ImageHelpers.DrawCheckers(Canvas.Width, Canvas.Height, VIrecordResources.Theme.CheckerSize,
                            VIrecordResources.Theme.CheckerColor, VIrecordResources.Theme.CheckerColor2))
                        {
                    ...
                    {
                        using (Brush canvasBrush = new SolidBrush(VIrecordResources.Theme.CheckerColor))
                        {
        ...
        internal bool ShowExitConfirmation()
        {
            ...
            if (IsImageModified)
            {
                ...
                DialogResult dialogResult = MessageBox.Show(this, Resources.RegionCaptureForm_SaveChangesBeforeClosingEditor,
                    Resources.RegionCaptureForm_ShowExitConfirmation_VIrecordImageEditor, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
