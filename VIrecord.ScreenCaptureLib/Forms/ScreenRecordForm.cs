...
namespace VIrecord.ScreenCaptureLib
{
    public partial class ScreenRecordForm : Form
    {
        ...
        private void UpdateUI()
        {
            switch (Status)
            {
                case ScreenRecordingStatus.Working:
                    string trayTextWorking = "VIrecord - " + Resources.ScreenRecordForm_StartRecording_Click_tray_icon_to_stop_recording_;
                ...
                case ScreenRecordingStatus.Paused:
                    ...
                    {
                        string trayTextWaiting = "VIrecord - " + Resources.ScreenRecordForm_StartRecording_Click_tray_icon_to_stop_recording_;
                        niTray.Text = trayTextWaiting.Truncate(63);
                    }
                    else
                    {
                        string trayTextBeforeStart = "VIrecord - " + Resources.ScreenRecordForm_StartRecording_Click_tray_icon_to_start_recording_;
            ...
            this.InvokeSafe(() =>
            {
                switch (state)
                {
                    case ScreenRecordState.Waiting:
                        string trayTextWaiting = "VIrecord - " + Resources.ScreenRecordForm_StartRecording_Waiting___;
                        niTray.Text = trayTextWaiting.Truncate(63);
                        niTray.Icon = Resources.control_record_yellow.ToIcon();
                    ...
                    case ScreenRecordState.Encoding:
                        Hide();
                        cmsMain.Enabled = false;
                        string trayTextAfterStop = "VIrecord - " + Resources.ScreenRecordForm_StartRecording_Encoding___;
        ...
        {
            niTray.Text = $"VIrecord - {Resources.ScreenRecordForm_StartRecording_Encoding___} {progress}%";
        ...
        {
            using (Pen pen1 = new Pen(VIrecordResources.Theme.BorderColor) { DashPattern = new float[] { 5, 5 } })
        ...
        private void btnAbort_MouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                if (!AskConfirmationOnAbort || MessageBox.Show(Resources.ScreenRecordForm_ConfirmCancel, "VIrecord", MessageBoxButtons.YesNo,
