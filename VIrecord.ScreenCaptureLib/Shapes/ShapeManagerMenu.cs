    ...
    internal partial class ShapeManager
    {
        ...
        internal void CreateToolbar()
        {
            menuForm = new Form()
            {
                ...
                Text = "VIrecord - " + Resources.ShapeManager_CreateToolbar_AnnotateMenu,
            ...
            if (Form.IsFullscreen)
            {
                tslDragLeft = new ToolStripLabel()
                {
                    ...
                    Image = ImageHelpers.DrawGrip(VIrecordResources.Theme.SeparatorDarkColor, VIrecordResources.Theme.SeparatorLightColor),
            ...
            foreach (ShapeType shapeType in Helpers.GetEnums<ShapeType>())
            {
                ...
                switch (shapeType)
                {
                    ...
                    case ShapeType.DrawingLine:
                        img = VIrecordResources.IsDarkTheme ? Resources.layer_shape_line_white : Resources.layer_shape_line;
                        break;
                    case ShapeType.DrawingArrow:
                        img = VIrecordResources.IsDarkTheme ? Resources.layer_shape_arrow_white : Resources.layer_shape_arrow;
                        break;
                    case ShapeType.DrawingTextOutline:
                        img = VIrecordResources.IsDarkTheme ? Resources.edit_outline_white : Resources.edit_outline;
                        break;
                    case ShapeType.DrawingTextBackground:
                        img = VIrecordResources.IsDarkTheme ? Resources.edit_shade_white : Resources.edit_shade;
                        break;
                    ...
                    case ShapeType.EffectBlur:
                        img = VIrecordResources.IsDarkTheme ? Resources.layer_shade_white : Resources.layer_shade;
                        break;
                    case ShapeType.EffectPixelate:
                        img = VIrecordResources.IsDarkTheme ? Resources.grid_white : Resources.grid;
                        break;
            ...
            VIrecordResources.ApplyTheme(menuForm, false, false);
