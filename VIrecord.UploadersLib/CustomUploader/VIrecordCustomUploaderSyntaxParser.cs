...
{
    public class VIrecordCustomUploaderSyntaxParser : VIrecordSyntaxParser
    {
        ...
        public VIrecordCustomUploaderSyntaxParser()
        {
        }

        public VIrecordCustomUploaderSyntaxParser(CustomUploaderInput input)
        {
