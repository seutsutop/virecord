...
using VIrecord.UploadersLib.FileUploaders;
using VIrecord.UploadersLib.ImageUploaders;
using VIrecord.UploadersLib.Properties;
using VIrecord.UploadersLib.SharingServices;
using VIrecord.UploadersLib.TextUploaders;
using VIrecord.UploadersLib.URLShorteners;
using System;
    ...
    public partial class CustomUploaderSettingsForm : Form
    {
        ...
        private void CustomUploaderSerialize(CustomUploaderItem cui, string folderPath)
        {
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show(Resources.ExportFailed + "\n\n" + e, "VIrecord - " + "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void CustomUploaderUpdateFolder()
        {
            ...
            if (!string.IsNullOrEmpty(selectedPath))
            {
                ...
                MessageBox.Show($"{updated} custom uploader files updated.", "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
                ...
                try
                {
                    switch (type)
                    {
                        case CustomUploaderDestinationType.ImageUploader:
                            using (Stream stream = VIrecordResources.Logo.GetStream())
                            {
                        ...
                        case CustomUploaderDestinationType.TextUploader:
                            ...
                            using (TextUploadForm form = new TextUploadForm("VIrecord text upload test"))
                            {
        ...
        private void CustomUploaderSyntaxHighlight(RichTextBox rtb)
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                VIrecordCustomUploaderSyntaxParser parser = new VIrecordCustomUploaderSyntaxParser();
        ...
        private void CustomUploaderFormatJsonData(Formatting formatting)
        {
            ...
            if (!string.IsNullOrEmpty(json))
            {
                ...
                {
                    MessageBox.Show(e.Message, "VIrecord - Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private object eiCustomUploaders_ExportRequested()
        {
            ...
            if (uploader != null)
            {
                ...
                {
                    MessageBox.Show(Resources.UploadersConfigForm_eiCustomUploaders_ExportRequested_RequestURLMustBeConfigured, "VIrecord - " + Resources.UploadersConfigForm_Error,
                ...
                if (uploader.DestinationType == CustomUploaderDestinationType.None)
                {
                    MessageBox.Show(Resources.UploadersConfigForm_eiCustomUploaders_ExportRequested_DestinationTypeMustBeConfigured, "VIrecord - " + Resources.UploadersConfigForm_Error,
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return null;
                }
        ...
        {
            if (MessageBox.Show(Resources.UploadersConfigForm_Remove_all_custom_uploaders_Confirmation, "VIrecord",
