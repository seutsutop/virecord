    ...
    public partial class ResponseForm : Form
    {
        ...
        private void tsbResponseTextJSONFormat_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(response))
            {
                ...
                {
                    MessageBox.Show(Resources.FormattingFailed_JSON, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void tsbResponseTextXMLFormat_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(response))
            {
                ...
                {
                    MessageBox.Show(Resources.FormattingFailed_XML, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
