    ...
    public partial class UploadersConfigForm : Form
    {
        ...
        private void btnImageShackLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(Resources.UploadersConfigForm_Login_successful, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show(Resources.UploadersConfigForm_Login_failed, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
        ...
        private async void btnFTPTest_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.UploadersConfigForm_FTPOpenClient_Unable_to_find_valid_FTP_account_, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
...
"VIrecord - Google Drive", MessageBoxButtons.OK, MessageBoxIcon.Question);
        }
        ...
        private void btnSeafileCheckAPIURL_Click(object sender, EventArgs e)
        {
            ...
            if (checkReturned)
            {
                MessageBox.Show(Resources.UploadersConfigForm_TestFTPAccount_Connected_, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(Resources.UploadersConfigForm_Error, "VIrecord", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
