...
namespace VIrecord.UploadersLib
{
    public class UploadersConfig : SettingsBase<UploadersConfig>
    {
        ...
        public string DropboxUploadPath { get; set; } = "VIrecord/%y/%mo";
        ...
        public string EmailDefaultSubject { get; set; } = "Sending email from VIrecord";
        ...
        public string B2UploadPath { get; set; } = "VIrecord/%y/%mo";
        ...
        public string GoogleCloudStorageObjectPrefix { get; set; } = "VIrecord/%y/%mo";
