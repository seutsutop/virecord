...
using VIrecord.IndexerLib.Properties;
using System;
using System.IO;
using System.Text;

namespace VIrecord.IndexerLib
{
    public class IndexerHtml : Indexer
    {
        ...
        {
            return $"Generated by <a href=\"{Links.Website}\">VIrecord Directory Indexer</a> on {DateTime.UtcNow:yyyy-MM-dd 'at' HH:mm:ss 'UTC'}";
        }
