...
using VIrecord.HistoryLib.Properties;
using System;
    ...
    public abstract class HistoryManager
    {
        ...
        public List<HistoryItem> GetHistoryItems()
        {
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show(Resources.ErrorOccuredWhileReadingHistoryFile + " " + FilePath + "\r\n\r\n" + e,
                    "VIrecord - " + Resources.HistoryManager_GetHistoryItems_Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        public void Test(string filePath, int itemCount)
        {
            HistoryItem historyItem = new HistoryItem()
            {
                ...
                FilePath = @"C:\VIrecord\Screenshots\Example.png",
