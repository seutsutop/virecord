...
namespace VIrecord.HistoryLib
{
    public class HistoryImageListViewRenderer : ImageListView.ImageListViewRenderer
    {
        public override void InitializeGraphics(Graphics g)
        {
            ...
            ImageListView.BackColor = VIrecordResources.Theme.BackgroundColor;
            ImageListView.Colors.BackColor = VIrecordResources.Theme.LightBackgroundColor;
            ImageListView.Colors.BorderColor = VIrecordResources.Theme.BorderColor;
            ImageListView.Colors.ForeColor = VIrecordResources.Theme.TextColor;
            ImageListView.Colors.SelectedForeColor = VIrecordResources.Theme.TextColor;
            ImageListView.Colors.UnFocusedForeColor = VIrecordResources.Theme.TextColor;

            Color hoverColor;
            if (VIrecordResources.IsDarkTheme)
            {
                hoverColor = ColorHelpers.LighterColor(VIrecordResources.Theme.LightBackgroundColor, 0.1f);
            }
            else
            {
                hoverColor = ColorHelpers.DarkerColor(VIrecordResources.Theme.LightBackgroundColor, 0.1f);
            }
