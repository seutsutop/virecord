...
namespace VIrecord.ImageEditor.Presentation.Controllers;
...
public class EditorSelectionController
{
    ...
    public bool OnPointerPressed(object sender, PointerPressedEventArgs e)
    {
        ...
        // VIrecord logic: If in Select Tool, selecting works. If in other tools, usually drawing takes precedence unless we click a handle.
    ...
    private void HandleResize(Point currentPoint, bool isShiftHeld = false)
    {
        ...
        if (_selectedShape is VIrecord.ImageEditor.Presentation.Controls.SpotlightControl spotlight && spotlight.Annotation is SpotlightAnnotation sa)
        {
    ...
    public void UpdateSelectionHandles()
    {
        ...
        if (_selectedShape is VIrecord.ImageEditor.Presentation.Controls.SpotlightControl spotlightControl && spotlightControl.Annotation is SpotlightAnnotation spotlightAnn)
        {
