...
using VIrecord.ImageEditor.Core.ImageEffects.Helpers;
...
public class EditorInputController
{
    ...
    public async void OnCanvasPointerPressed(object? sender, PointerPressedEventArgs e)
    {
        ...
        switch (vm.ActiveTool)
        {
            ...
            case EditorTool.Freehand:
                ...
                if (vm.ShadowEnabled)
                {
                    path.Effect = VIrecord.ImageEditor.Presentation.Helpers.ShadowEffectHelper.CreateDropShadow(shadowColor);
                }
    ...
    public void OnCanvasPointerMoved(object? sender, PointerEventArgs e)
    {
        ...
        else if (_currentShape is VIrecord.ImageEditor.Presentation.Controls.SpotlightControl spotlight)
        {
    ...
    private void HandleTextTool(Canvas canvas, SolidColorBrush brush, double strokeWidth)
    {
        ...
        if (vm.ShadowEnabled)
        {
            textBox.Effect = VIrecord.ImageEditor.Presentation.Helpers.ShadowEffectHelper.CreateDropShadow(shadowColor);
        }
