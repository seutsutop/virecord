    ...
    public partial class MainViewModel : ViewModelBase
    {
        ...
        private void UpdateCanvasProperties()
        {
            if (AreBackgroundEffectsActive)
            {
                ...
                CanvasShadow = new BoxShadows(VIrecord.ImageEditor.Presentation.Helpers.ShadowEffectHelper.CreateCanvasShadow(_options.ShadowColor, BackgroundShadowRadius));
