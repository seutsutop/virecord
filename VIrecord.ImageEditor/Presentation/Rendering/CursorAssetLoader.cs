...
namespace VIrecord.ImageEditor.Presentation.Rendering
{
    internal static class CursorAssetLoader
    {
        ...
        private static readonly Uri ClosedHandCursorUri = new("avares://VIrecord.ImageEditor/Assets/closedhand.cur");
        private static readonly Uri CrosshairCursorUri = new("avares://VIrecord.ImageEditor/Assets/Crosshair.cur");
        private static readonly Uri OpenHandCursorUri = new("avares://VIrecord.ImageEditor/Assets/openhand.cur");
