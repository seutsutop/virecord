    ...
    public partial class EditorView : UserControl
    {
        ...
        private void OnFavoriteEffectsMenuRequested(object? sender, Control target)
        {
            ...
            var menu = new ContextMenu
            {
                ...
                BorderBrush = (IBrush?)Resources["VIrecord.Brush.Border"],
        ...
        private void ApplySelectedShadowState(bool isEnabled)
        {
            ...
            if (selected is Control control)
            {
                if (isEnabled)
                {
                    control.Effect = VIrecord.ImageEditor.Presentation.Helpers.ShadowEffectHelper.CreateDropShadow(annotation.ShadowColor);
                }
                else
                {
                    control.Effect = null;
