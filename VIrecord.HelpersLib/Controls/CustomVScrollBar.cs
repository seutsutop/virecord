...
namespace VIrecord.HelpersLib
{
    public class CustomVScrollBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (SolidBrush trackBrush = new SolidBrush(VIrecordResources.Theme.DarkBackgroundColor))
            {
            ...
            Color thumbColor = isThumbHovered ? ColorHelpers.LighterColor(VIrecordResources.Theme.LightBackgroundColor, 0.1f) : VIrecordResources.Theme.LightBackgroundColor;
            using (SolidBrush thumbBrush = new SolidBrush(thumbColor))
            {
                e.Graphics.FillRectangle(thumbBrush, thumbRect);
            }

            using (Pen borderPen = new Pen(ColorHelpers.DarkerColor(VIrecordResources.Theme.DarkBackgroundColor, 0.03f)))
            {
