...
namespace VIrecord.HelpersLib
{
    public partial class MyPictureBox : UserControl
    {
        ...
        {
            lblImageSize.BackColor = VIrecordResources.Theme.BackgroundColor;
            lblImageSize.ForeColor = VIrecordResources.Theme.TextColor;

            VIrecordResources.ApplyCustomThemeToContextMenuStrip(cmsMenu);
        }
        ...
        public void UpdateCheckers(bool forceUpdate = false)
        {
            if (DrawCheckeredBackground)
            {
                if (forceUpdate || pbMain.BackgroundImage == null || pbMain.BackgroundImage.Size != pbMain.ClientSize)
                {
                    ...
                    {
                        pbMain.BackgroundImage = ImageHelpers.CreateCheckerPattern(VIrecordResources.Theme.CheckerSize, VIrecordResources.Theme.CheckerSize,
                            VIrecordResources.Theme.CheckerColor, VIrecordResources.Theme.CheckerColor2);
                    }
                    else
                    {
                        pbMain.BackColor = VIrecordResources.Theme.CheckerColor;
