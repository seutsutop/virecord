...
namespace VIrecord.HelpersLib
{
    public static class FileHelpers
    {
        ...
        public static bool OpenFile(string filePath)
        {
            ...
            {
                MessageBox.Show(Resources.Helpers_OpenFile_File_not_exist_ + Environment.NewLine + filePath, "VIrecord",
        ...
        public static bool OpenFolder(string folderPath, bool allowMessageBox = true)
        {
            ...
            {
                MessageBox.Show(Resources.Helpers_OpenFolder_Folder_not_exist_ + Environment.NewLine + folderPath, "VIrecord",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        {
            return BrowseFile("VIrecord - " + Resources.Helpers_BrowseFile_Choose_file, tb, initialDirectory, detectSpecialFolders, filter);
        }
        ...
        {
            return BrowseFolder("VIrecord - " + Resources.Helpers_BrowseFolder_Choose_folder, tb, initialDirectory, detectSpecialFolders);
        }
        ...
        public static string GetVariableFolderPath(string path, bool supportCustomSpecialFolders = false)
        {
            if (!string.IsNullOrEmpty(path))
            {
                try
                {
                    ...
                    {
                        foreach (KeyValuePair<string, string> specialFolder in HelpersOptions.VIrecordSpecialFolders)
                        {
        ...
        public static string RenameFile(string filePath, string newFileName)
        {
            ...
            {
                MessageBox.Show("Rename file error:\r\n" + e.ToString(), "VIrecord - " + Resources.Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
