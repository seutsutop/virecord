...
{
    public static class VIrecordResources
    {
        public static string Name { get; set; } = "VIrecord";
        ...
        public static bool UseWhiteIcon
        {
            ...
            set
            {
                if (useWhiteIcon != value)
                {
                    ...
                    if (useWhiteIcon)
                    {
                        Icon = Resources.VIrecord_Icon_White;
                    }
                    else
                    {
                        Icon = Resources.VIrecord_Icon;
                    }
                }
            }
        }

        private static Icon icon = Resources.VIrecord_Icon;
        ...
        private static Bitmap logo = Resources.VIrecord_Logo;
        ...
        public static VIrecordTheme Theme { get; set; } = VIrecordTheme.DarkTheme;
