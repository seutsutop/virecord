...
namespace VIrecord.HelpersLib
{
    public class VIrecordTheme
    {
        ...
        private VIrecordTheme()
        {
        }

        public static VIrecordTheme DarkTheme => new VIrecordTheme()
        {
            Name = "Dark",
        ...
        public static VIrecordTheme LightTheme => new VIrecordTheme()
        {
            Name = "Light",
        ...
        public static VIrecordTheme NightTheme => new VIrecordTheme()
        {
            Name = "Night",
        ...
        public static VIrecordTheme NordDarkTheme => new VIrecordTheme()
        {
            Name = "Nord Dark",
        ...
        // https://www.nordtheme.com
        public static VIrecordTheme NordLightTheme => new VIrecordTheme()
        {
            Name = "Nord Light",
        ...
        public static VIrecordTheme DraculaTheme => new VIrecordTheme()
        {
            Name = "Dracula",
        ...
        public static List<VIrecordTheme> GetDefaultThemes()
        {
            return new List<VIrecordTheme>() { DarkTheme, LightTheme, NightTheme, NordDarkTheme, NordLightTheme, DraculaTheme };
        }
