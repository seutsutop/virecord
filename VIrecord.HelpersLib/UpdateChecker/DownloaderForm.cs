...
namespace VIrecord.HelpersLib
{
    public partial class DownloaderForm : Form
    {
        ...
        // This function will give time for VIrecord to close so installer won't tell VIrecord is already running
        ...
        private async Task StartDownload()
        {
            if (!string.IsNullOrEmpty(URL) && Status == DownloaderFormStatus.Waiting)
            {
                ...
                string folderPath = Path.Combine(Path.GetTempPath(), "VIrecord");
