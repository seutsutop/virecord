...
#define MyAppPublisher "VIrecord Team"
#define MyAppURL "https://getVIrecord.com"
#define MyAppId "82E6AC09-0FEF-4390-AD9F-0DD3F5561EFC"

[Setup]
AppCopyright=Copyright (c) 2007-2026 VIrecord Team
AppId={#MyAppId}
AppMutex={#MyAppId}
AppName={#MyAppName}
...
Name: "CreateContextMenuButton"; Description: "Show ""Upload with VIrecord"" button in Windows Explorer context menu"; GroupDescription: "Additional shortcuts:"; Check: not IsUpdating
Name: "CreateSendToIcon"; Description: "Create a send to shortcut"; GroupDescription: "Additional shortcuts:"; Check: not IsUpdating
Name: "CreateStartupIcon"; Description: "Run VIrecord when Windows starts"; GroupDescription: "Other tasks:"; Check: not IsUpdating
...
Source: "{#MyAppReleaseDirectory}\VIrecord_File_Icon.ico"; DestDir: {app}; Flags: ignoreversion
...
Root: "HKCU"; Subkey: "Software\Classes\VIrecord.sxcu"; Flags: dontcreatekey uninsdeletekey
Root: "HKCU"; Subkey: "Software\Classes\.sxie"; Flags: dontcreatekey uninsdeletekey
Root: "HKCU"; Subkey: "Software\Classes\VIrecord.sxie"; Flags: dontcreatekey uninsdeletekey
Root: "HKCU"; Subkey: "Software\Classes\SystemFileAssociations\image\shell\VIrecordImageEditor"; Flags: dontcreatekey uninsdeletekey
Root: "HKCU"; Subkey: "SOFTWARE\Google\Chrome\NativeMessagingHosts\com.getVIrecord.VIrecord"; ValueType: string; ValueData: "{app}\host-manifest-chrome.json"; Flags: uninsdeletekey; Tasks: EnableBrowserExtensionSupport
Root: "HKCU"; Subkey: "SOFTWARE\Mozilla\NativeMessagingHosts\VIrecord"; ValueType: string; ValueData: "{app}\host-manifest-firefox.json"; Flags: uninsdeletekey; Tasks: EnableBrowserExtensionSupport
